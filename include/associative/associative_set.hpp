...
template <typename Key> class associative_set : public container {
public:
   ...
   * @note Runtime complexity: O(log n) for ordered containers, O(1) on average
...
template <typename Key> class associative_multi_set : public container {
public:
...
template <typename Key> class ordered_set : public associative_set<Key> {
  // Adding a virtual destructor, because this class is not going to be
  // implemented
  virtual ~ordered_set() override = default;
};

template <typename Key> class ordered_multi_set : public associative_set<Key> {
  // Adding a virtual destructor, because this class is not going to be
  // implemented
...
template <typename Key> class hashing_set : public associative_set<Key> {
private:
