...
y1 = [27, 14.67, 107.33, 1131, 11017, 117692.67];

% Dataset of hash_multi_set
x2 = [1, 10, 100, 1000, 10000, 100000];
y2 = [36.67, 23.67, 1512.67, 39390, 1776907.33, 431136200];
...
title('Benchmark Comparison: unordered\_multiset vs hash\_multiset (insert)', 'FontSize', 16, 'FontWeight', 'bold');
