...
y1 = [78, 55.33, 276, 1990.67, 20358.33, 214753];

% Dataset of hash_multi_set
x2 = [1, 10, 100, 1000, 10000, 100000];
y2 = [135.67, 89, 2412.33, 65640.67, 3585519.33, 726332859];
...
title('Benchmark Comparison: unordered\_multiset vs hash\_multiset (exists)', 'FontSize', 16, 'FontWeight', 'bold');
