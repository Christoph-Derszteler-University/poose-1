...
y1 = [27.33, 36, 268, 2292.33, 22794, 235404.33];

% Dataset of hash_map
x2 = [1, 10, 100, 1000, 10000, 100000];
y2 = [143, 140.67, 2192, 72038.67, 3606619, 749352925.7];
...
title('Benchmark Comparison: unordered\_map vs hash\_map (remove)', 'FontSize', 16, 'FontWeight', 'bold');
