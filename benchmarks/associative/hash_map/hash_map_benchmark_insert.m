...
y1 = [15.67, 17, 157, 1166, 8182.33, 115134.67];

% Dataset of hash_map
x2 = [1, 10, 100, 1000, 10000, 100000];
y2 = [97.67, 18, 1602.33, 39995.67, 1765815.67, 431239775];
...
title('Benchmark Comparison: unordered\_map vs hash\_map (insert)', 'FontSize', 16, 'FontWeight', 'bold');
